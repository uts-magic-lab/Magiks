...
class Key_Point_Orientation(Key_Point):
   def __init__(self, phi, pos, vel=None, acc=None):
       
       super(PyRide_PR2, self).__init__(phi = phi, pos = pos, vel = vel, acc = acc)
...
## This class contains properties and methods for a \em Trajectory Segment
    ...
    def points_dist(self):
        ...
        if n_pnt > 1:  
            ...
            return dist
             ...
             print  "Error from " + __name__ + func_name + ": The segment must have at least two key points"       
